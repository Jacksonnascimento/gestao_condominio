...
ADD COLUMN MOR_DT_INICIO_OCUPACAO DATE,
ADD COLUMN MOR_DT_FIM_OCUPACAO DATE,
ADD COLUMN MOR_PERIODO_USO VARCHAR(100),
ADD COLUMN MOR_TIPO_PERIODO VARCHAR(50);


-- REMOVA A TABELA ANTIGA SE ELA EXISTIR
DROP TABLE IF EXISTS GC_MORADOR;

-- CRIE A NOVA TABELA PADRONIZADA
