...
CREATE TABLE GC_CONDOMINIO (
    ...
    CON_GERACAO_AUTO_ATIVA BOOLEAN DEFAULT false,
    CON_DIA_GERACAO_COBRANCA INT NULL,
    PRIMARY KEY (CON_COD)
);
...
CREATE TABLE GC_TIPO_COBRANCA (
    ...
    TIC_IS_TAXA_PRINCIPAL BOOLEAN DEFAULT false,
    TIC_GERACAO_AUTOMATICA BOOLEAN DEFAULT false,
    PRIMARY KEY (TIC_COD),
    FOREIGN KEY (CON_COD) REFERENCES GC_CONDOMINIO (CON_COD)
);
...
VALUES ('Jackson', '12345678901', 'F', 'jacksonnascimento84@hotmail.com', '$2a$10$J1twi2Hzs.L58XyTlVsDzOjB817gltdN3ODubuGmlwMZdS0px55qO', true, true);
