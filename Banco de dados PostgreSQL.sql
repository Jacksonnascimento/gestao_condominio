...
ALTER TABLE GC_TIPO_COBRANCA
ADD COLUMN TIC_GERACAO_AUTOMATICA BOOLEAN DEFAULT false;

CREATE TABLE GC_DESPESA_CATEGORIA (
    DCA_COD INT GENERATED BY DEFAULT AS IDENTITY,
    DCA_DESCRICAO VARCHAR(100) NOT NULL UNIQUE,
    DCA_ATIVA BOOLEAN DEFAULT true NOT NULL,
    PRIMARY KEY (DCA_COD)
);

CREATE TABLE GC_FINANCEIRO_DESPESA (
    DES_COD INT GENERATED BY DEFAULT AS IDENTITY,
    CON_COD INT NOT NULL,
    ...
    DCA_COD INT NOT NULL,
    PRIMARY KEY (DES_COD),
    FOREIGN KEY (CON_COD) REFERENCES GC_CONDOMINIO (CON_COD),
    FOREIGN KEY (DCA_COD) REFERENCES GC_DESPESA_CATEGORIA (DCA_COD)
);


-- Adicionando as novas colunas na tabela de unidades
ALTER TABLE GC_UNIDADE
ADD COLUMN UNI_BLOCO VARCHAR(50),
ADD COLUMN UNI_ANDAR VARCHAR(50),
ADD COLUMN UNI_FRACAO_IDEAL DECIMAL(5, 4),
