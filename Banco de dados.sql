...
--CREATE DATABASE GESTAO_CONDOMINIO
...
ADD ADM_DT_CADASTRO DATETIME DEFAULT GETDATE(),
ADM_DT_ATUALIZACAO DATETIME;
...
ADD UNI_VALOR_TAXA_CONDOMINIO DECIMAL(10, 2) NOT NULL DEFAULT 0.00;
...
CREATE TABLE GC_SOLICITACAO_MANUTENCAO (
    ...
    SMA_DESCRICAO_PROBLEMA VARCHAR(MAX) NOT NULL,       
...
CREATE TABLE GC_USUARIO_CONDOMINIO (
    ...
    USC_ATIVO_ASSOCIACAO BIT DEFAULT 1 NOT NULL,
...
ALTER TABLE GC_USUARIO_CONDOMINIO
ADD USC_DT_ATUALIZACAO DATETIME;



ALTER TABLE GC_ADMINISTRADORA
ADD ADM_ATIVO BIT DEFAULT 1; 



ALTER TABLE GC_ASSEMBLEIA
ADD ASS_ATIVA BIT DEFAULT 1; 



ALTER TABLE GC_CONDOMINIO
ADD CON_ATIVO BIT DEFAULT 1; 


CREATE TABLE GC_TIPO_SOLICITACAO_MANUTENCAO (
    TSM_COD INT IDENTITY (1,1),
    TSM_DESCRICAO VARCHAR(100) NOT NULL UNIQUE, 
    TSM_DT_CADASTRO DATETIME DEFAULT GETDATE(),
    TSM_DT_ATUALIZACAO DATETIME,
    TSM_ATIVA BIT DEFAULT 1, 
...
ALTER TABLE GC_SOLICITACAO_MANUTENCAO
DROP COLUMN SMA_CATEGORIA;


ALTER TABLE GC_SOLICITACAO_MANUTENCAO
ADD TSM_COD INT NOT NULL;


ALTER TABLE GC_SOLICITACAO_MANUTENCAO
ADD CONSTRAINT FK_SOLICITACAO_TIPO
FOREIGN KEY (TSM_COD) REFERENCES GC_TIPO_SOLICITACAO_MANUTENCAO (TSM_COD);


ALTER TABLE GC_TIPO_COBRANCA
ADD TIC_ATIVA BIT DEFAULT 1


ALTER TABLE GC_UNIDADE
ADD UNI_ATIVA BIT DEFAULT 1; 



ALTER TABLE GC_MORADOR
ALTER COLUMN MOR_TIPO_RELACIONAMENTO VARCHAR(50) NOT NULL;


CREATE TABLE GC_ADMINISTRADORA_USUARIO (
    ADU_COD INT IDENTITY (1,1),
    ADM_COD INT NOT NULL,
    PES_COD INT NOT NULL,
    ADU_PAPEL VARCHAR(50) NOT NULL,
    ADU_DT_CADASTRO DATETIME DEFAULT GETDATE() NOT NULL,
    ADU_DT_ATUALIZACAO DATETIME,
    ADU_ATIVO BIT DEFAULT 1 NOT NULL,
...
ALTER TABLE GC_CONDOMINIO
ALTER COLUMN CON_TIPOLOGIA VARCHAR(50) NOT NULL;



ALTER TABLE GC_UNIDADE
ALTER COLUMN UNI_STATUS_OCUPACAO VARCHAR(50) NOT NULL;



ALTER TABLE GC_FINANCEIRO_COBRANCA
ALTER COLUMN FIC_STATUS_PAGAMENTO VARCHAR(50) NOT NULL;



ALTER TABLE GC_RESERVA_AREA_COMUM
ALTER COLUMN RAC_STATUS VARCHAR(50) NOT NULL;



ALTER TABLE GC_SOLICITACAO_MANUTENCAO
ALTER COLUMN SMA_STATUS VARCHAR(50) NOT NULL;



ALTER TABLE GC_GESTAO_COMUNICACAO
ALTER COLUMN COM_TIPO_NOTIFICACAO VARCHAR(50) NULL; -- Pode ser NULL conforme seu script original



ALTER TABLE GC_ASSEMBLEIA
ALTER COLUMN ASS_STATUS VARCHAR(50) NOT NULL;



ALTER TABLE GC_ASSEMBLEIA_VOTO
ALTER COLUMN ASV_VOTO VARCHAR(50) NULL



ALTER TABLE GC_PESSOA
ADD PES_IS_GLOBAL_ADMIN BIT NOT NULL DEFAULT 0;


-- Define o seu usuário (PES_COD = 1) como um Administrador Global
UPDATE GC_PESSOA
SET PES_IS_GLOBAL_ADMIN = 1
WHERE PES_COD = 1;
