...
public class UsuarioCondominioController {
    ...
    @DeleteMapping("/{pesCod}/{conCod}/{papel}")
    public ResponseEntity<Void> deletarUsuarioCondominio(@PathVariable Integer pesCod, @PathVariable Integer conCod, @PathVariable UserRole papel) {
        UsuarioCondominioId id = new UsuarioCondominioId(pesCod, conCod, papel);
        usuarioCondominioService.deletarUsuarioCondominio(id);
