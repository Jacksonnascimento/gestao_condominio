...
public class UsuarioCondominioController {
    ...
    public ResponseEntity<UsuarioCondominio> buscarUsuarioCondominioPorId(@PathVariable Integer pesCod, @PathVariable Integer conCod, @PathVariable Character papel) {
        UsuarioCondominioId id = new UsuarioCondominioId(pesCod, conCod, Character.toUpperCase(papel));
    ...
    public ResponseEntity<UsuarioCondominio> atualizarUsuarioCondominio(@PathVariable Integer pesCod, @PathVariable Integer conCod, @PathVariable Character papel, @RequestBody UsuarioCondominio usuarioCondominioAtualizado) {
        UsuarioCondominioId id = new UsuarioCondominioId(pesCod, conCod, Character.toUpperCase(papel));
    ...
    public ResponseEntity<UsuarioCondominio> inativarUsuarioCondominio(@PathVariable Integer pesCod, @PathVariable Integer conCod, @PathVariable Character papel) {
        UsuarioCondominioId id = new UsuarioCondominioId(pesCod, conCod, Character.toUpperCase(papel));
    ...
    public ResponseEntity<UsuarioCondominio> ativarUsuarioCondominio(@PathVariable Integer pesCod, @PathVariable Integer conCod, @PathVariable Character papel) {
        UsuarioCondominioId id = new UsuarioCondominioId(pesCod, conCod, Character.toUpperCase(papel));
