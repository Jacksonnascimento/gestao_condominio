...
public class FinanceiroDespesaService {
    ...
    public FinanceiroDespesa cadastrarDespesa(FinanceiroDespesa despesa) {
        ...
        internalCheckPermissionToManageFinance(despesa.getCondominio().getConCod());
    ...
    public FinanceiroDespesa atualizarDespesa(Integer id, FinanceiroDespesa despesaAtualizada) {
        ...
        internalCheckPermissionToManageFinance(despesaExistente.getCondominio().getConCod());
    ...
    public boolean hasPermissionToManageFinanceByCondominioId(Integer condominioId) {
        Authentication authentication = SecurityContextHolder.getContext().getAuthentication();
    ...
    public boolean hasPermissionToManageFinanceByDespesaId(Integer despesaId) {
        FinanceiroDespesa despesa = financeiroDespesaRepository.findById(despesaId)
                .orElseThrow(() -> new IllegalArgumentException("Despesa não encontrada com o ID: " + despesaId));
        return hasPermissionToManageFinanceByCondominioId(despesa.getCondominio().getConCod());
    }

    
    private void internalCheckPermissionToManageFinance(Integer condominioId) {
        Authentication authentication = SecurityContextHolder.getContext().getAuthentication();
